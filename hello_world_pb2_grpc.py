...
class WorldStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HelloWorld = channel.unary_unary(
                ...
                request_serializer=hello__world__pb2.HelloWorldReq.SerializeToString,
                response_deserializer=hello__world__pb2.HelloWorldReply.FromString,
...
def add_WorldServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HelloWorld': grpc.unary_unary_rpc_method_handler(
                    servicer.HelloWorld,
                    request_deserializer=hello__world__pb2.HelloWorldReq.FromString,
                    response_serializer=hello__world__pb2.HelloWorldReply.SerializeToString,
            ),
    }
...
class World(object):
    ...
    def HelloWorld(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/test.World/HelloWorld',
            hello__world__pb2.HelloWorldReq.SerializeToString,
            hello__world__pb2.HelloWorldReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
